function Game()
{
    ...
    this.camera = new THREE.PerspectiveCamera(60, 16.0 / 9.0, 0.1, 1000.0)
    this.scene.add(this.camera)
    this.camera.position.set(this.board.boardWidth/2, 7, -this.board.boardHeight/2 + 4)
    ...
    this.players = {
        left: new Player(HQ.typesEnum.NATURE, this.board, new PadController(1)),
        right: new Player(HQ.typesEnum.NEW_YORK, this.board, new PadController(0))
    }
}
